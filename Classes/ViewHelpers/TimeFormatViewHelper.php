...
Class Tx_EcAssociation_ViewHelpers_TimeFormatViewHelper Extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	...
	Public Function render($amount) {
		...
		Return number_format($amount, 2, ',', '').' '.Tx_Extbase_Utility_Localization::translate('ViewHelper_Unit_'.$unit, 'EcAssociation');
	}
