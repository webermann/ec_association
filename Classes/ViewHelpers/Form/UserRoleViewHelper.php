...
Class Tx_EcAssociation_ViewHelpers_Form_UserRoleViewHelper Extends Tx_Fluid_ViewHelpers_Form_SelectViewHelper {
	...
	Protected Function getOptions() {
		 ...
		 * the user (specified by the "user" argument) is a member of the current association
		 * (specified by the "association" argument) in a specific role.
		 ...
		 *             the user is not a member of the association.
		 *
		 */

	Protected Function getSelectedValue() {
		$assignment = $this->arguments['association'] ? $this->arguments['association']->getAssignmentForUser($this->arguments['user']) : NULL;
