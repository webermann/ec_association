 ...
 *                                                                      */
	 ...
	 * @version    $Id: AssociationRepository.php 28 2010-09-20 12:26:13Z helmich $
	 * @license    GNU Public License, version 2
	 *             http://opensource.org/licenses/gpl-license.php
	 *
	 */

Class Tx_EcAssociation_Domain_Repository_AssociationRepository Extends Tx_Extbase_Persistence_Repository {
		 ...
		 * @return Array<Tx_EcAssociation_Domain_Model_Association>  The result list.
		 *
		 */

	Public Function findForIndexView ( Tx_EcAssociation_Domain_Model_Association $parent=NULL ) {

		$query = $this->createQuery();
		Return $query
			->matching($query->equals('association', $parent ? $parent : Array(0,NULL) ))
